...
const Sidebar = ({open, setOpen}) => {
  ...
  return (
    ...
    >
      ...
      <div className="border-b border-gray-700 p-1 pl-3 pb-6">
      ...
      <div className="mt-6">
        <div className="flex flex-col gap-5">
          {Menus.map(({ title, href, icon }) => (
            <Link
              href={href}
              key={title + 1}
              className={`flex items-center gap-4 p-1 pl-3 ${path === href && "border border-gray-700 rounded-xl"}`}
            >
              <span>{icon}</span>
        ...
        <div className="mt-5 border-t pt-5 p-1 pl-3 border-gray-700">
